    ...
    <ScrollView className={styles.page} scrollY>
      ...
      <View className={styles.section}>
        <View className={styles.sectionHeader}>
          <Text className={styles.sectionTitle}>最新发布</Text>
            ...
            return (
              <View key={post.id} className={styles.hotPostCard}>
                <View className={styles.hotPostHeader}>
                  ...
                  <Text className={styles.hotPostTime}>{post.createdAt}</Text>
                </View>
                ...
                <View className={styles.hotPostTags}>
                  ...
                  {post.visibility === 'friends' && <View className={styles.hotPostTag} style={{ backgroundColor: '#a78bfa20', color: '#a78bfa' }}>仅好友</View>}
      ...
      <View className={styles.section}>
        ...
        <View className={styles.hotPosts}>
          {sortedPosts.slice(2, 5).map(post => {
            const emotion = emotionLabels[post.emotion]
            return (
              <View key={post.id} className={styles.hotPostCard}>
                <View className={styles.hotPostHeader}>
